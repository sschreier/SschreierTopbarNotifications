...
class SschreierTopbarNotifications extends Plugin
{
    ...
    const PLUGIN_VARS = [
        ...
        'fontSizeTopBarArea1' => 'sschreier-fontsize-topbararea1',
        'fontSizeTopBarArea2' => 'sschreier-fontsize-topbararea2',
        'fontSizeTopBarArea3' => 'sschreier-fontsize-topbararea3',
        'fontSizeTopBarArea4' => 'sschreier-fontsize-topbararea4',
    ];
